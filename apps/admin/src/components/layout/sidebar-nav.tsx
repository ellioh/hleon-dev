...
import { Briefcase, FolderKanban, LayoutDashboard, LogOut, Newspaper, User } from "lucide-react";
...
const ITEMS = [
  ...
  // Servicios/Certificaciones se agregan aquí con el mismo patrón cuando
  // existan - sin tocar el resto del shell.
